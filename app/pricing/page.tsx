...
const plans = [
  {
    ...
    price: 'From $15,000',
    period: 'project',
    tagline: 'Design your first workflow',
    description:
      '2-4 week engagement to design, build, and deploy workflows aligned with your governance. All artifacts remain with your organization.',
    features: [
      '1-2 production workflows with HITL gates',
      'Complete documentation and runbooks',
      'Observability and monitoring setup',
      'Governance framework aligned with your controls',
      'Knowledge transfer and handoff session',
    ],
    cta: 'Discuss Pilot',
    href: '/contact',
    popular: true,
  },
  {
    ...
    price: 'From $50,000',
    period: 'project',
    tagline: 'Expand with governance',
    description:
      '6-12 week engagement to expand workflows integrated into your existing operating model and approval structures.',
    features: [
      '3-8 production workflows with oversight',
      'Integration with enterprise systems',
      'Advanced observability and alerting',
      'Cross-workflow orchestration',
      'Internal capability building and documentation',
    ],
    cta: 'Discuss Scale',
    href: '/contact',
    popular: false,
  },
  {
    ...
    price: 'From $5,000',
    period: 'month',
    tagline: 'Ongoing capability building',
    description:
      'Knowledge transfer and support to maintain what we build together. Your team operates independently.',
    features: [
      'Monthly workshop training',
      'Office hours (4 hours/month)',
      'Pattern documentation support',
      'Priority response for questions',
      'Quarterly capability and governance review',
    ],
    cta: 'Discuss Enable',
    href: '/contact',
    popular: false,
