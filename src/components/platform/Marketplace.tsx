  ...
  const loadMarketplaceItems = async () => {
    ...
    const mockItems: MarketplaceItem[] = [
      // Workflow Templates
      {
        ...
        description:
          'Automatically qualify leads using AI-powered scoring and routing',
        category: 'sales',
        price: 0,
        currency: 'USD',
        author: {
      ...
      },
      {
        ...
        description:
          'Complete customer onboarding workflow with email sequences and task assignments',
      ...
      },
      {
        ...
        description:
          'Automated invoice processing with OCR, validation, and approval routing',
        category: 'finance',
        price: 199,
        currency: 'USD',
        author: {
      ...
      // AI Agents
      {
        ...
        description:
          'Intelligent customer support agent with natural language understanding',
      ...
      // Integrations
      {
        ...
        description:
          'Seamless integration with Salesforce for lead management and automation',
        category: 'crm',
        price: 0,
        currency: 'USD',
        author: {
      ...
      },
      {
        ...
        description:
          'Connect your workflows to Slack for notifications and team collaboration',
      ...
      // One-time Apps
      {
        ...
        description:
          'One-time data migration tool for moving data between systems',
        category: 'data',
        price: 149,
        currency: 'USD',
        author: {
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-gray-600'>
            Discover and deploy automation solutions
          </p>
        </div>
                  ...
                  >
                    <CardHeader className='pb-3'>
                      <div className='flex items-start justify-between'>
                        <div className='flex items-center gap-3'>
                          <div
                            className={`rounded-lg p-2 ${colorClass} text-white`}
                          >
