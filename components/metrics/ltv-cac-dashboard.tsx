...
export function LTVCACDashboard() {
  ...
  if (loading) {
    return <div className='py-8 text-center'>Loading metrics...</div>;
  }

  if (!metrics) {
    return <div className='py-8 text-center'>No metrics available</div>;
  }

  const isHealthy =
    metrics.ltvCacRatio >= 3 && metrics.nrr >= 100 && metrics.monthlyChurn < 5;
          ...
          <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Current revenue and customer metrics
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className='space-y-4'>
                  ...
                  <div className='flex justify-between'>
                    ...
                    <span className='text-lg font-semibold'>
                      {metrics.monthlyChurn.toFixed(1)}%
                    </span>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent>
                <div className='space-y-4'>
                  ...
                  <div className='flex justify-between'>
                    ...
                    <span
                      className={`text-lg font-semibold ${metrics.ltvCacRatio >= 3 ? 'text-green-600' : 'text-red-600'}`}
                    >
                      {metrics.ltvCacRatio.toFixed(1)}:1
                    </span>
                  </div>
                  ...
                  <div key={channel.channel} className='rounded-lg border p-4'>
                    <div className='mb-2 flex items-start justify-between'>
                      ...
                      <div className='text-right'>
                        <div
                          className={`text-2xl font-bold ${channel.ltvCacRatio >= 3 ? 'text-green-600' : 'text-red-600'}`}
                        >
        ...
        <TabsContent className='space-y-4' value='historical'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                LTV:CAC ratio and key metrics over time
              </CardDescription>
            </CardHeader>
            <CardContent>
