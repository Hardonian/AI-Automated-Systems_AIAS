      ...
      <div className='container mx-auto px-4 py-8'>
        ...
        <div className='mb-8 grid grid-cols-1 gap-6 md:grid-cols-4'>
          ...
          <Card>
            ...
            <CardContent>
              <div className='text-2xl font-bold'>
                {partnerData.qualifiedReferrals}
              </div>
              <p className='text-xs text-muted-foreground'>
                {Math.round(
                  (partnerData.qualifiedReferrals /
          ...
          <Card>
            ...
            <CardContent>
              <div className='text-2xl font-bold'>
                ${partnerData.totalCommission.toLocaleString()}
              </div>
              <p className='text-xs text-muted-foreground'>
          ...
          <Card>
            ...
            <CardContent>
              <div className='text-2xl font-bold'>
                {(partnerData.tier.benefits.commission * 100).toFixed(0)}%
              </div>
              <p className='text-xs text-muted-foreground'>
                {partnerData.tier.benefits.bonus > 0 &&
                  `+$${partnerData.tier.benefits.bonus} bonus per lead`}
              </p>
            </CardContent>
          </Card>
        </div>
            ...
            <div className='grid grid-cols-1 gap-6 lg:grid-cols-2'>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Current partnership tier advantages
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className='space-y-4'>
                    <div className='flex items-center space-x-3'>
                      ...
                      <div>
                        ...
                        <p className='text-sm text-gray-500'>
                          {(partnerData.tier.benefits.commission * 100).toFixed(
                            0
                          )}
                          % on all qualified referrals
                        </p>
                      </div>
                    </div>
                    <div className='flex items-center space-x-3'>
                      ...
                      <div>
                        ...
                        <p className='text-sm text-gray-500'>
                          ${partnerData.tier.benefits.bonus} bonus for each
                          qualified lead
                        </p>
                      </div>
                    </div>
                    <div className='flex items-center space-x-3'>
                      ...
                      <div>
                        ...
                        <p className='text-sm text-gray-500'>
                          {partnerData.tier.benefits.support}
                        </p>
                      </div>
                    </div>
            ...
            <div className='grid grid-cols-1 gap-6 lg:grid-cols-2'>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Download and customize marketing assets
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className='space-y-4'>
                ...
                <CardContent>
                  <div className='space-y-4'>
                    <div className='rounded-lg border p-4'>
                      <h4 className='mb-2 font-medium'>Webinar Series</h4>
                    ...
                    <div className='rounded-lg border p-4'>
                      <h4 className='mb-2 font-medium'>Trade Show Presence</h4>
                      <p className='mb-3 text-sm text-gray-500'>
                ...
                <CardContent>
                  <div className='space-y-4'>
                    <div className='rounded-lg border p-4'>
                      ...
                      <p className='mb-3 text-sm text-gray-500'>
                        sarah.johnson@aias-consultancy.com
                      </p>
          ...
          <TabsContent className='space-y-6' value='settings'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Manage your partnership account
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className='space-y-6'>
