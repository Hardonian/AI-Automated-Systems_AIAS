...
export function UsageProgressBanner({
  ...
  return (
    <Card
      className={`mb-4 ${isCritical ? 'border-red-500 bg-red-50 dark:bg-red-950/20' : 'border-amber-500 bg-amber-50 dark:bg-amber-950/20'}`}
    >
          ...
          <div className='flex-1'>
            <div className='mb-2 flex items-center gap-2'>
              ...
              <h3 className='font-semibold'>
                {isCritical
                  ? "You're almost out of automations!"
                  : "You're using AIAS a lot!"}
              </h3>
            </div>
