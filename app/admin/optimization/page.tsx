...
export default function OptimizationPage() {
  ...
  if (loading) {
    return (
      <div className='container mx-auto p-6'>
        <h1 className='mb-6 text-3xl font-bold'>Optimization Opportunities</h1>
  ...
  return (
    <div className='container mx-auto p-6'>
      <div className='mb-6'>
        <h1 className='mb-2 text-3xl font-bold'>Optimization Opportunities</h1>
      ...
      <div className='grid gap-6'>
                    ...
                    <CardHeader>
                      <div className='flex items-start justify-between'>
                        ...
                        <div className='flex gap-2'>
                          ...
                          <Badge
                            variant={
                              candidate.effort === 'low' ? 'default' : 'outline'
                            }
                          >
                      ...
                      <div className='space-y-2'>
                        ...
                        <div className='mt-3 rounded-lg bg-muted p-3'>
                          ...
                          <div className='text-sm text-muted-foreground'>
                            {candidate.suggestedImplementation}
                          </div>
                        </div>
                      </div>
                    </CardContent>
                ...
                {candidates.map(candidate => (
                  ...
                  >
                    ...
                    <div className='ml-4 flex gap-2'>
                      ...
                      <Badge
                        variant={
                          candidate.impact === 'high' ? 'default' : 'secondary'
                        }
                      >
                        {candidate.impact}
                      </Badge>
        ...
        {candidates.length === 0 && (
          <Alert>
            ...
            <AlertDescription>
              No optimization opportunities detected at this time. Check back
              later for new insights.
            </AlertDescription>
          </Alert>
        )}
      </div>
