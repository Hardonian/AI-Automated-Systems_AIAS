  ...
  return (
    <div className='container mx-auto space-y-8 px-4 py-10'>
      <div className='space-y-2'>
        <h1 className='text-3xl font-bold md:text-4xl'>Internal Review</h1>
        <p className='text-muted-foreground'>
          Fast visual polish harness for preview deployments. Environment:{' '}
          <span className='font-medium'>{props.envLabel}</span>
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Open key flows/pages in new tabs during polish passes.
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Force common UI states to speed up review.
          </CardDescription>
        </CardHeader>
              ...
              <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
                <Card className='shadow-card'>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Driven by runtime tokens (`--shadow-card`, `--radius`).
                    </CardDescription>
                  </CardHeader>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Spot-check heading, body, and button sizes.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className='space-y-3'>
                    <p className='text-sm'>
                      Use this page to sanity-check contrast, hover states,
                      focus rings, and mobile wrapping behavior.
                    </p>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Source: <span className='font-medium'>{props.source}</span>. This is
            what the frontend reads at runtime.
          </CardDescription>
        </CardHeader>
        <CardContent className='space-y-3'>
          <Button
      ...
      {props.canEdit ? (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Saves to DB-backed runtime config. Requires same-origin + CSRF
              token.
            </CardDescription>
          </CardHeader>
          <CardContent className='space-y-3'>
