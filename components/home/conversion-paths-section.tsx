...
const conversionPaths: ConversionPath[] = [
  {
    ...
    constraints: 'Requires deterministic controls, review gates, and deployment accountability.',
  ...
  },
  {
    ...
    constraints: 'Static-first, type-safe, and performance-budget constrained delivery.',
    value: 'Converts architecture quality into faster iteration and stronger trust.',
    cta: '/services/automation-web',
  },
  {
    title: 'Strategic Partnerships',
    icp: 'For ecosystem partners extending Reach, Zeo, and Settler capabilities.',
    constraints: 'Needs clear interface contracts, governance interoperability, and shared SLAs.',
    value: 'Accelerates system rollout with aligned advisory + implementation layers.',
    cta: '/ecosystem',
  },
];
      ...
      <div className='container'>
        ...
        <div className='mt-8 grid gap-6 md:grid-cols-3'>
          {conversionPaths.map((path) => (
            <div className='rounded-xl border bg-background p-6' key={path.title}>
