      ...
      setHypotheses([
        {
          ...
          area: 'Problem',
          statement:
            'We believe Canadian SMBs waste 10-30 hours/week on repetitive manual tasks and would pay $49/month to automate them',
          status: 'partially_tested',
          testMethods: ['Customer interviews', 'Surveys', 'Market research'],
          successCriteria:
            '80%+ confirm problem exists, 50%+ willing to pay $49/month',
          confidence: 'medium',
        },
        {
          id: '2',
          ...
          statement:
            'We believe Canadian e-commerce SMBs (Shopify store owners) are the best initial customer segment',
          status: 'untested',
          testMethods: [
        ...
        },
        {
          ...
          area: 'Solution',
          statement:
            'We believe visual workflow builders solve the problem by allowing users to automate tasks without coding',
          status: 'untested',
          testMethods: ['Concierge MVP', 'Beta testing', 'Prototype testing'],
          successCriteria:
            '70%+ successfully create workflows, < 2 days time-to-activation',
          confidence: 'low',
        },
        {
          id: '4',
          area: 'Revenue Model',
          statement:
            'We believe $49/month subscription pricing is the right model',
          status: 'untested',
          testMethods: [
            'Pricing tests',
            'Conversion tracking',
          ...
          successCriteria:
            '10%+ conversion rate (free → paid), $49 ARPU, 3:1 LTV:CAC',
          confidence: 'low',
        },
        {
          id: '5',
          area: 'Growth Channel',
          statement:
            'We believe Shopify App Store is the best initial growth channel',
          status: 'untested',
          testMethods: [
            'Submit app to Shopify App Store',
            'Track installs and activations',
          ],
          successCriteria:
            '100+ installs/month, 20%+ activation rate, lower CAC than other channels',
          confidence: 'low',
        },
      ]);
    } finally {
          ...
          <Card key={hypothesis.id}>
            <CardHeader>
              <div className='flex items-start justify-between'>
                ...
                <div className='flex gap-2'>
                  ...
                  <Badge
                    className={getConfidenceColor(hypothesis.confidence)}
                    variant='outline'
                  >
            ...
            <CardContent>
              <div className='space-y-4'>
                <div>
                  <h4 className='mb-2 font-semibold'>Test Methods</h4>
