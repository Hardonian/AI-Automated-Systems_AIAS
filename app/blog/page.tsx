    ...
    <>
      ...
      <div className="container py-16">
        ...
        <Card className="mb-8 border-primary/20 bg-primary/10">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              When building your content system, consider{" "}
              <strong>Notion</strong> for interconnected knowledge management,{" "}
              <strong>Zapier</strong> for process automation (remember:
              automation alone isn't enough — apply systems thinking), or{" "}
              <strong>Make</strong> for advanced workflow orchestration. Each
              tool is powerful, but systems thinking ensures they work together
              effectively.
            </p>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <p className="mb-4 text-muted-foreground">
              Get daily AI and tech news from top sources (TechCrunch, The
              Verge, MIT Technology Review, Hacker News, etc.) analyzed through
              our systems thinking framework. Each news item is evaluated for
              systems thinking relevance and provided with insights.
            </p>
            <Button asChild>
              <Link href={`mailto:${siteContent.contact.email}`}>
                Request RSS Access
