  ...
  async function fetchExperiments() {
    try {
      ...
      logger.error(
        ...
        {
          component: 'GrowthExperimentsPage',
      ...
      setExperiments([
        {
          ...
          hypothesis:
            'We believe optimizing the onboarding flow will increase activation rate from [current]% to 40%+',
          status: 'planned',
        ...
        },
        {
          ...
          hypothesis:
            'We believe offering commission-based referral rewards will increase referral rate from 5% to 15%',
          status: 'planned',
          startDate: new Date().toISOString(),
          metrics: {
        ...
        },
        {
          ...
          hypothesis:
            'We believe emphasizing benefits and social proof will increase conversion rate to 10%+',
          status: 'planned',
          startDate: new Date().toISOString(),
          metrics: {
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  <div className='text-sm text-muted-foreground'>
                    <p>
                      <strong>Primary:</strong> {experiment.metrics.primary}
                    </p>
                    <p>
                      <strong>Secondary:</strong>{' '}
                      {experiment.metrics.secondary.join(', ')}
                    </p>
                  </div>
                </div>
                {experiment.results && (
                  <div>
                    ...
                    <div className='text-sm text-muted-foreground'>
                      ...
                      {experiment.results.winner && (
                        <p>
                          <strong>Winner:</strong> {experiment.results.winner}
                        </p>
                      )}
                    </div>
                  </div>
                ...
                {experiment.learnings && (
                  <div>
                    <h4 className='mb-2 font-semibold'>Learnings</h4>
