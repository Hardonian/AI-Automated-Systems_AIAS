  ...
  if (loading) {
    return (
      <div className='container mx-auto p-6'>
        <h1 className='mb-6 text-3xl font-bold'>Performance Dashboard</h1>
        <div className='py-12 text-center'>Loading metrics...</div>
      </div>
    );
  }
          ...
          <div className='grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4'>
            <Card>
              ...
              <CardContent>
                ...
                <div
                  className={`mt-2 text-sm ${metrics.api.p95 < 500 ? 'text-green-600' : metrics.api.p95 < 1000 ? 'text-yellow-600' : 'text-red-600'}`}
                >
                  {metrics.api.p95 < 500
                    ? 'Excellent'
                    : metrics.api.p95 < 1000
                      ? 'Good'
                      : 'Needs Attention'}
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div
                  className={`mt-2 text-sm ${metrics.api.errorRate < 0.01 ? 'text-green-600' : metrics.api.errorRate < 0.05 ? 'text-yellow-600' : 'text-red-600'}`}
                >
                  {metrics.api.errorRate < 0.01
                    ? 'Excellent'
                    : metrics.api.errorRate < 0.05
                      ? 'Good'
                      : 'Needs Attention'}
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div
                  className={`mt-2 text-sm ${metrics.cache.hitRate > 0.7 ? 'text-green-600' : metrics.cache.hitRate > 0.5 ? 'text-yellow-600' : 'text-red-600'}`}
                >
        ...
        <TabsContent className='space-y-4' value='database'>
          <div className='grid grid-cols-1 gap-4 md:grid-cols-3'>
            ...
            <Card>
              ...
              <CardContent>
                <div className='text-2xl font-bold'>
                  {(metrics.database.connectionPoolUsage * 100).toFixed(1)}%
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <div className='grid grid-cols-1 gap-4 md:grid-cols-3'>
            <Card>
              ...
              <CardContent>
                ...
                <div
                  className={`mt-2 text-sm ${metrics.webVitals.lcp < 2500 ? 'text-green-600' : metrics.webVitals.lcp < 4000 ? 'text-yellow-600' : 'text-red-600'}`}
                >
                  {metrics.webVitals.lcp < 2500
                    ? 'Good'
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div
                  className={`mt-2 text-sm ${metrics.webVitals.fid < 100 ? 'text-green-600' : metrics.webVitals.fid < 300 ? 'text-yellow-600' : 'text-red-600'}`}
                >
                  {metrics.webVitals.fid < 100
                    ? 'Good'
                    : metrics.webVitals.fid < 300
                      ? 'Needs Improvement'
                      : 'Poor'}
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div
                  className={`mt-2 text-sm ${metrics.webVitals.cls < 0.1 ? 'text-green-600' : metrics.webVitals.cls < 0.25 ? 'text-yellow-600' : 'text-red-600'}`}
                >
                  {metrics.webVitals.cls < 0.1
                    ? 'Good'
                    : metrics.webVitals.cls < 0.25
                      ? 'Needs Improvement'
                      : 'Poor'}
                </div>
              </CardContent>
