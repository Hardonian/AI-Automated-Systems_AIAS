...
export async function GET(request: NextRequest) {
  try {
    ...
    signupEvents?.forEach(
      (event: { properties?: { signup_source?: string } }) => {
    ...
    return NextResponse.json({
      ...
      retention: {
        day7:
          pmfSnapshot?.seven_day_retention || activationMetrics.day7Retention,
      ...
      engagement: {
        ...
        mau:
          pmfSnapshot?.monthly_active_users ||
          activationMetrics.uniqueActiveUsers,
      ...
      pmf: {
        ...
        timeToActivation:
          pmfSnapshot?.time_to_activation_hours ||
          activationMetrics.timeToActivation / (1000 * 60 * 60),
