...
export const metadata: Metadata = {
  title:
    'Case Studies — AIAS Consultancy | Custom Builds & Platform Success Stories',
  description:
    'See custom AI platforms and automation systems built by AIAS Consultancy. Case studies include TokPulse TikTok analytics and Hardonia Suite ecosystems, plus client success stories.',
};
...
const caseStudies = [
  {
    ...
    flag: '🇬🇧',
    challenge:
      'Managing educational programs across 15 countries with different currencies, languages, and regulatory requirements. Manual stakeholder communication and administrative tasks consumed 20+ hours per week.',
    solution:
      'Implemented AIAS Platform with multi-currency support, Google Workspace automation, and custom AI agents for stakeholder communication across different time zones and markets.',
    results: [
  ...
  },
  {
    ...
    flag: '🇨🇦',
    challenge:
      'Manual order processing and customer support was taking 15+ hours per week. Expanding to US and EU markets required handling multiple currencies and payment processors.',
    solution:
      'Implemented AIAS Platform with Shopify integration, multi-currency Stripe automation, and AI-powered customer support agents that handle inquiries in multiple languages.',
    results: [
    ...
    quote:
      'AIAS saves me 12 hours per week on order processing and customer support. The global integrations and multi-currency support make it perfect for our international e-commerce business. Setup took 25 minutes, and we expanded to new markets without any additional complexity.',
    author: 'Emma Chen',
    role: 'Store Owner',
  },
  {
    ...
    flag: '🇸🇬',
    challenge:
      'Tech company serving clients in North America, Europe, and APAC needed to automate operations across different time zones, currencies, and compliance requirements (GDPR, PIPEDA).',
    solution:
      'Deployed AIAS Platform with enterprise security features, regional data residency options, and automated workflows for CRM, invoicing, and client communication across all markets.',
    results: [
    ...
    quote:
      "The enterprise security and global compliance (GDPR, PIPEDA) are crucial for our organization. We serve clients in North America, Europe, and APAC, and AIAS handles all our automation needs seamlessly. The platform's understanding of global business operations is exactly what we needed.",
...
const consultancyBuilds = [
  {
    ...
    flag: '🇨🇦',
    challenge:
      'TikTok advertising requires constant monitoring, optimization, and creative testing. Manual management is time-consuming and inefficient for e-commerce brands and agencies.',
    solution:
      "AIAS Consultancy designed and built TokPulse as a complete TikTok analytics platform with custom AI agents that automate campaign optimization, creative testing, and performance analysis. This isn't a backend integration—it's a full platform we built from the ground up.",
    results: [
  ...
  },
  {
    ...
    flag: '🇨🇦',
    challenge:
      "E-commerce operations require coordination across multiple channels, inventory systems, and customer touchpoints. Manual processes don't scale, and generic solutions don't fit unique business needs.",
    solution:
      'AIAS Consultancy architected and built the Hardonia Suite as a comprehensive e-commerce automation ecosystem. Custom AI agents handle order processing, inventory sync, customer support, and multi-channel coordination. This is a complete platform build showcasing our consultancy capabilities.',
    results: [
    ...
    <div className='container py-16'>
      <div className='mb-12 text-center'>
        ...
        <p className='mx-auto max-w-3xl text-lg text-muted-foreground'>
          AIAS Consultancy builds custom AI platforms, workflow automation
          systems, and intelligent agents. See platforms we've built (like
          TokPulse and Hardonia Suite) and how our clients use AIAS Platform to
          save 10+ hours/week.
        </p>
      ...
      <section className='mb-16'>
        <div className='mb-8 text-center'>
          ...
          <p className='mx-auto max-w-3xl text-lg text-muted-foreground'>
            These aren't backend integrations—they're complete platforms we've
            built from the ground up. Showcasing our expertise in custom AI
            agent development, workflow automation, and intelligent platform
            architecture.
          </p>
        </div>
            ...
            consultancyBuilds.map(build => (
              ...
              >
                  ...
                  <div className='flex items-start justify-between'>
                    <div>
                      ...
                      <CardDescription className='flex items-center gap-2 text-base'>
                        {build.company} • {build.industry} • {build.location}{' '}
                        {build.flag}
                      </CardDescription>
                    </div>
                ...
                <CardContent className='pt-6'>
                  ...
                  <div className='mb-6 rounded-lg border border-primary/20 bg-gradient-to-br from-primary/10 to-primary/5 p-8'>
      ...
      <section>
        <div className='mb-8 text-center'>
          <h2 className='mb-4 text-3xl font-bold'>Client Success Stories</h2>
          <p className='mx-auto max-w-3xl text-lg text-muted-foreground'>
            See how businesses worldwide save 10+ hours/week using AIAS
            Platform. Real results from e-commerce, education, consulting, and
            global enterprises.
          </p>
        </div>
      ...
      <div className='mt-12 space-y-4 rounded-lg bg-muted/50 p-8 text-center'>
        <h2 className='text-2xl font-bold'>
          Ready to Work with AIAS Consultancy?
        </h2>
        <p className='text-muted-foreground'>
          Need a custom AI platform built? Or want to automate your business
          with AIAS Platform? Let's discuss your project and see how we can
          help.
        </p>
