...
export const metadata: Metadata = {
  ...
  description:
    'Analyze your device capabilities and create profiles for edge AI optimization. Support for AI PCs, Jetsons, mobile devices, and more.',
};
  ...
  return (
    <div className='container py-12 md:py-16'>
      <div className='mb-12 text-center'>
        <h1 className='mb-4 text-4xl font-bold md:text-5xl'>Device Analyzer</h1>
        <p className='mb-8 text-xl text-muted-foreground'>
          Create device profiles for your target hardware. Use templates or
              ...
              >
                ...
                <CardContent>
                  <Button
                    ...
                    variant='outline'
                  >
                    <Link href={`/edge-ai/device-analyzer/${device.type}`}>
                      Use Template
                    </Link>
                  </Button>
                </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure a custom device profile with specific hardware
            specifications.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className='space-y-4'>
            <p className='text-sm text-muted-foreground'>
              Specify CPU cores, GPU model, NPU capabilities, memory, and
              runtime environment.
            </p>
            <Button asChild>
              <Link href='/edge-ai/device-analyzer/custom'>
      ...
      <div className='mt-8'>
        <h2 className='mb-4 text-2xl font-bold'>Your Device Profiles</h2>
        <Card>
