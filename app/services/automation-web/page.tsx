...
export const metadata: Metadata = generateSEOMetadata({
  ...
  description: 'Static-first website automation architecture with governed intake, conversion routing, and performance-first delivery.',
    ...
    <>
      ...
      <PageSection>
        <div className='grid gap-6 md:grid-cols-2'>
          ...
          <SurfaceCard><h2 className='text-xl font-bold'>Governance model</h2><p className='mt-3 text-muted-foreground'>Every intake path has policy checks, escalation criteria, and explicit ownership.</p></SurfaceCard>
          <SurfaceCard><h2 className='text-xl font-bold'>Architecture approach</h2><p className='mt-3 text-muted-foreground'>Server components by default, static-safe pages, and JSON artifacts for downstream execution.</p></SurfaceCard>
          <SurfaceCard><h2 className='text-xl font-bold'>Ecosystem tie-in</h2><p className='mt-3 text-muted-foreground'>Reach handles demand strategy, Zeo handles implementation, and Settler supports operating handoff.</p></SurfaceCard>
        </div>
      </PageSection>
    </>
  );
