...
export default function AppAiSystemsServicePage() {
  return (
    <>
      ...
      <ServiceSchema
        name="App + AI Systems Engineering"
        description="Deterministic app orchestration with AI advisory layers."
        serviceType="App orchestration consulting"
      />
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <SurfaceCard>
            ...
            <p className="mt-3 text-muted-foreground">
              Critical paths stay deterministic. AI augments planning and triage
              under schema-bound contracts.
            </p>
          </SurfaceCard>
          <SurfaceCard>
            <h2 className="text-xl font-bold">Governance model</h2>
            <p className="mt-3 text-muted-foreground">
              Policy enforcement, replayable logs, and human approval for
              high-impact actions.
            </p>
          </SurfaceCard>
          <SurfaceCard>
            ...
            <p className="mt-3 text-muted-foreground">
              Modular control plane, tool adapters, and environment-specific
              deployment profiles.
            </p>
          </SurfaceCard>
          <SurfaceCard>
            <h2 className="text-xl font-bold">Performance + OSS alignment</h2>
            <p className="mt-3 text-muted-foreground">
              Open standards, auditable interfaces, and latency budgets tracked
