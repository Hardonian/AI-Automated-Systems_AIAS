...
const COLORS = CHART_COLORS.extended.slice(0, 5);
      ...
      {summary && (
        <div className='grid gap-4 md:grid-cols-4'>
          ...
          <Card>
            ...
            <CardContent>
              <div className='text-2xl font-bold'>
                ${(summary.totalCommitted / 1000).toFixed(0)}K
              </div>
        ...
        <TabsContent className='space-y-4' value='list'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Track investor meetings and deal status
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  >
                    ...
                    {investor.dateMeeting && (
                      <div className='text-sm text-muted-foreground'>
                        Meeting:{' '}
                        {new Date(investor.dateMeeting).toLocaleDateString()}
                      </div>
                    )}
            ...
            <>
                    ...
                    <PieChart>
                      <Pie
                        ...
                        data={[
                          ...
                          {
                            name: 'Strategic',
                            value: (summary.byType as any).strategic || 0,
                          },
                        ]}
                        dataKey='value'
                        fill='#8884d8'
                      ...
                      >
                        {[
                          summary.byType.vc,
                          summary.byType.angel,
                          (summary.byType as any).strategic || 0,
                        ].map((_entry, index) => (
                          <Cell
                            key={`cell-${index}`}
              ...
              <Card>
                ...
                <CardContent>
                  <ResponsiveContainer height={300} width='100%'>
                    <BarChart
                      data={Object.entries(summary.byStatus).map(
                        ([status, count]) => ({
                          status: status
                            .replace(/_/g, ' ')
