    ...
    <div className='mx-auto w-full max-w-7xl space-y-8 p-6'>
      ...
      <div className='flex items-center justify-between'>
        <div className='flex items-center gap-4'>
          <div className='rounded-lg bg-gradient-to-r from-green-500 to-blue-600 p-3'>
          ...
          <CardContent className='p-6'>
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-sm text-gray-500'>
                  Due{' '}
                  {billingData.billing.nextInvoice.date.toLocaleDateString()}
                </p>
              </div>
              ...
              <CardContent className='space-y-4'>
                <div>
                  <div className='mb-2 flex items-center justify-between'>
                    ...
                    <span className='text-sm text-gray-600'>
                      {billingData.usage.workflows.used} /{' '}
                      {billingData.usage.workflows.limit === -1
                        ? '∞'
                        : billingData.usage.workflows.limit}
                    </span>
                  </div>
                  <Progress
                    className='h-2'
                ...
                <div>
                  <div className='mb-2 flex items-center justify-between'>
                    ...
                    <span className='text-sm text-gray-600'>
                      {billingData.usage.executions.used.toLocaleString()} /{' '}
                      {billingData.usage.executions.limit.toLocaleString()}
                    </span>
                  </div>
                  <Progress
                    className='h-2'
                    value={getUsagePercentage(
                      billingData.usage.executions.used,
                      billingData.usage.executions.limit
                    )}
                  />
                </div>
                ...
                <div>
                  ...
                  <Progress
                    className='h-2'
                    value={
                      typeof billingData.usage.storage === 'object' &&
                      'used' in billingData.usage.storage &&
                      'limit' in billingData.usage.storage
                        ? getUsagePercentage(
                            billingData.usage.storage.used,
                ...
                <div>
                  ...
                  <Progress
                    className='h-2'
                    value={getUsagePercentage(
                      billingData.usage.apiCalls.used,
                ...
                <div className='space-y-4'>
                  <div className='text-center'>
                    ...
                    <div className='text-sm text-gray-600'>
                      {billingData.currentPlan.name} Plan
                    </div>
                  </div>
                  ...
                  <div className='space-y-3'>
                    ...
                    <div className='flex items-center justify-between text-sm'>
                      ...
                      <span className='font-medium'>
                        {billingData.billing.paymentMethod.brand} ••••{' '}
            ...
            <Card>
              ...
              <CardContent className='space-y-6'>
                {Object.entries(billingData.usage).map(([key, value]) => {
                  ...
                  const limit =
                    typeof value === 'object' && 'limit' in value
                      ? value.limit
                      : 0;
                  const used =
                    typeof value === 'object' && 'used' in value
                      ? value.used
                      : 0;
              ...
              <CardContent>
                <div className='space-y-4'>
                  ...
                  <div className='space-y-2'>
                    {billingData.billing.nextInvoice.items.map(
                      (item, index) => (
                        <div
                          key={index}
              ...
              <CardContent>
                <div className='space-y-2 text-sm'>
                  <div className='font-medium'>
                    {billingData.billing.billingAddress.name}
                  </div>
                  <div>{billingData.billing.billingAddress.company}</div>
                  <div>{billingData.billing.billingAddress.address}</div>
                  <div>
                    {billingData.billing.billingAddress.city},{' '}
                    {billingData.billing.billingAddress.state}{' '}
                    {billingData.billing.billingAddress.zip}
                  </div>
                ...
                <div className='space-y-4'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      <div className='text-sm text-gray-600'>
                        Expires {billingData.billing.paymentMethod.expiryMonth}/
                        {billingData.billing.paymentMethod.expiryYear}
                      </div>
                    </div>
                  </div>
