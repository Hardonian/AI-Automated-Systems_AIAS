      ...
      <div className='container py-8'>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Cost tracking has not been set up yet. Configure service
              integrations to start tracking costs.
            </CardDescription>
          </CardHeader>
        </Card>
      </div>
      ...
      <div className='space-y-6'>
        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-4'>
          ...
          <Card>
            ...
            <CardContent>
              <div className='text-2xl font-bold'>
                ${metrics.forecast.nextMonth.toFixed(2)}
              </div>
              <p className='text-xs text-muted-foreground'>
                {metrics.forecast.nextMonth > metrics.totalMonthly ? (
                  ...
                  <span className='text-green-600'>
                    -$
                    {(
                      metrics.totalMonthly - metrics.forecast.nextMonth
                    ).toFixed(2)}
                  </span>
                )}
              </p>
        ...
        <Tabs className='space-y-4' defaultValue='overview'>
              ...
              <CardContent>
                <div className='grid grid-cols-3 gap-4'>
                  ...
                  <div>
                    ...
                    <p className='text-2xl font-bold'>
                      ${metrics.forecast.nextQuarter.toFixed(2)}
                    </p>
                  </div>
                  <div>
                    <p className='text-sm text-muted-foreground'>Next Year</p>
                    <p className='text-2xl font-bold'>
                      ${metrics.forecast.nextYear.toFixed(2)}
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            {metrics.byService.map(service => (
              <Card key={service.service}>
                <CardHeader>
                  ...
                  <CardDescription>
                    {((service.total / metrics.totalMonthly) * 100).toFixed(1)}%
                    of total costs
                  </CardDescription>
                </CardHeader>
                <CardContent>
          ...
          <TabsContent value='settings'>
            <Card>
              ...
              <CardContent>
                <p className='text-sm text-muted-foreground'>
                  Threshold management coming soon. Use the API to configure
                  thresholds.
                </p>
              </CardContent>
            </Card>
