    ...
    <>
      ...
      <PageSection>
        <p className="mb-6 max-w-3xl text-sm text-muted-foreground">
          ...
          reliable AI outcomes without governance blind spots. We use a
          structured diagnostic framework to map decisions, constraints, and
          failure paths before implementation. The result is a delivery plan
          tied to business outcomes, with discovery first so architecture
