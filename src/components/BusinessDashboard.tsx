    ...
    <div className='space-y-6'>
      ...
      <div className='grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4'>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {formatPercentage(metrics?.conversion.visitorToPaid || 0)}
            </div>
            <div className='flex items-center text-xs text-muted-foreground'>
              <Activity className='mr-1 h-3 w-3 text-blue-500' />
              Trial to paid:{' '}
              {formatPercentage(metrics?.conversion.trialToPaid || 0)}
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className='flex items-center text-xs text-muted-foreground'>
              <Users className='mr-1 h-3 w-3 text-red-500' />
          ...
          <div className='grid grid-cols-1 gap-6 lg:grid-cols-2'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Workflows and executions per day
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer height={300} width='100%'>
              ...
              <CardContent className='space-y-4'>
                <div className='flex items-center justify-between'>
                  ...
                  <span className='text-2xl font-bold'>
                    {formatNumber(metrics?.usage.totalWorkflows || 0)}
                  </span>
                </div>
                <div className='flex items-center justify-between'>
                  <span className='text-sm font-medium'>Total Executions</span>
                  <span className='text-2xl font-bold'>
                    {formatNumber(metrics?.usage.totalExecutions || 0)}
                  </span>
                </div>
                <div className='flex items-center justify-between'>
                  <span className='text-sm font-medium'>Active Users</span>
                  <span className='text-2xl font-bold'>
                    {formatNumber(metrics?.usage.activeUsers || 0)}
                  </span>
                </div>
                <div className='flex items-center justify-between'>
                  <span className='text-sm font-medium'>API Calls</span>
                  <span className='text-2xl font-bold'>
                    {formatNumber(metrics?.usage.apiCalls || 0)}
                  </span>
                </div>
              </CardContent>
            </Card>
                ...
                <div className='space-y-2'>
                  <div className='flex items-center justify-between'>
                    ...
                    <span className='text-lg font-bold'>
                      {formatPercentage(
                        metrics?.conversion.visitorToTrial || 0
                      )}
                    </span>
                  </div>
                  <Progress
                    className='h-2'
                    value={metrics?.conversion.visitorToTrial || 0}
                  />
                </div>
                <div className='space-y-2'>
                  <div className='flex items-center justify-between'>
                  ...
                  <Progress
                    className='h-2'
                    value={metrics?.conversion.trialToPaid || 0}
                  />
                </div>
                <div className='space-y-2'>
                  <div className='flex items-center justify-between'>
                  ...
                  <Progress
                    className='h-2'
                    value={metrics?.conversion.visitorToPaid || 0}
                  />
                </div>
              </CardContent>
            </Card>
