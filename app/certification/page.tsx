      ...
      <PageSection>
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <SurfaceCard>
            ...
            <ul className="mt-4 space-y-2 text-muted-foreground">
              <li>
                • Submit completed exercises with deterministic controls
                documented.
              </li>
              <li>
                • Include one architecture diagram and one rollback/replay plan.
              </li>
              <li>
                • Provide a governance checklist that maps risks to owners.
              </li>
            </ul>
          </SurfaceCard>
        </div>
      ...
      <PageSection width="narrow">
        <SurfaceCard>
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            Submission guidance: open a GitHub issue with your artifacts or
            email inquiries@aiautomatedsystems.ca with subject line “AIAS
