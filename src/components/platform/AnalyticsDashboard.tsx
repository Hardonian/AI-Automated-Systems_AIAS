    ...
    try {
      ...
      const mockCohortData: CohortData[] = [
        ...
        },
        {
          cohort: 'Feb 2024',
          users: 120,
          retention: [100, 88, 82, 76, 71, 67, 64, 61, 59, 57, 55, 53],
        },
        {
          cohort: 'Mar 2024',
          users: 140,
          retention: [100, 90, 85, 80, 75, 71, 68, 65, 63, 61, 59, 57],
        },
      ];
                ...
                <div className='flex items-center justify-between'>
                  <div>
                    ...
                    <div className='mt-2 flex items-center'>
                      ...
                      <span
                        className={`text-sm ${getRevenueGrowth() >= 0 ? 'text-green-600' : 'text-red-600'}`}
                      >
                ...
                <div className='flex items-center justify-between'>
                  <div>
                    ...
                    <div className='mt-2 flex items-center'>
                      ...
                      <span
                        className={`text-sm ${getUsageGrowth() >= 0 ? 'text-green-600' : 'text-red-600'}`}
                      >
              ...
              <CardContent className='p-6'>
                <div className='flex items-center justify-between'>
                  <div>
                    ...
                    <p className='text-3xl font-bold text-gray-900'>
                      {formatNumber(
                        usageData[usageData.length - 1]?.users || 0
                      )}
                    </p>
                    <div className='mt-2 flex items-center'>
                      <TrendingUp className='mr-1 h-4 w-4 text-green-600' />
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4'>
                  <div className='text-center'>
                    <div className='text-3xl font-bold text-blue-600'>
                      {formatNumber(platformAnalytics.totalTenants)}
                    </div>
                    <div className='text-sm text-gray-600'>Total Tenants</div>
                  </div>
                  <div className='text-center'>
                    <div className='text-3xl font-bold text-green-600'>
                      {formatNumber(platformAnalytics.activeTenants)}
                    </div>
                  ...
                  <div className='text-center'>
                    <div className='text-3xl font-bold text-purple-600'>
                      {formatCurrency(
                        platformAnalytics.monthlyRecurringRevenue
                      )}
                    </div>
                  ...
                  <div className='text-center'>
                    <div className='text-3xl font-bold text-orange-600'>
                      {platformAnalytics.netPromoterScore}
                    </div>
            ...
            <Card>
              <CardContent className='p-4 text-center'>
                <div className='text-2xl font-bold text-blue-600'>
                  {formatCurrency(
                    revenueData.reduce((sum, day) => sum + day.subscriptions, 0)
                  )}
                </div>
            ...
            <Card>
              <CardContent className='p-4 text-center'>
                <div className='text-2xl font-bold text-green-600'>
                  {formatCurrency(
                    revenueData.reduce((sum, day) => sum + day.usage, 0)
                  )}
                </div>
            ...
            <Card>
              <CardContent className='p-4 text-center'>
                <div className='text-2xl font-bold text-yellow-600'>
                  {formatCurrency(
                    revenueData.reduce((sum, day) => sum + day.oneTime, 0)
                  )}
                </div>
            ...
            <Card>
              <CardContent className='p-4 text-center'>
                <div className='text-2xl font-bold text-red-600'>
                  {formatCurrency(
                    revenueData.reduce((sum, day) => sum + day.commissions, 0)
                  )}
                </div>
          ...
          <div className='grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4'>
            <Card>
              <CardContent className='p-4 text-center'>
                <div className='text-2xl font-bold text-blue-600'>
                  {formatNumber(
                    usageData.reduce((sum, day) => sum + day.executions, 0)
                  )}
                </div>
            ...
            <Card>
              <CardContent className='p-4 text-center'>
                <div className='text-2xl font-bold text-green-600'>
                  {formatNumber(
                    usageData.reduce((sum, day) => sum + day.workflows, 0)
                  )}
                </div>
            ...
            <Card>
              <CardContent className='p-4 text-center'>
                <div className='text-2xl font-bold text-yellow-600'>
                  {formatNumber(
                    usageData.reduce((sum, day) => sum + day.apiCalls, 0)
                  )}
                </div>
            ...
            <Card>
              <CardContent className='p-4 text-center'>
                <div className='text-2xl font-bold text-purple-600'>
                  {formatNumber(
                    usageData.reduce((sum, day) => sum + day.aiProcessing, 0)
                  )}
                </div>
                ...
                <CardContent className='p-4 text-center'>
                  ...
                  {index > 0 && (
                    <div className='mt-1 text-xs text-gray-400'>
                      {(
                        (stage.users / conversionData[index - 1].users) *
                        100
                      ).toFixed(1)}
                      % of previous
                    </div>
                ...
                {geographicData.map((country, index) => (
                  ...
                  >
                    ...
                    <div className='text-right'>
                      ...
                      <div
                        className={`text-sm ${country.growth >= 0 ? 'text-green-600' : 'text-red-600'}`}
                      >
                        {country.growth >= 0 ? '+' : ''}
