...
export const MarketplaceCommission: React.FC = () => {
  ...
  useEffect(() => {
    const revenue = marketplaceItems.reduce(
      (sum, item) => sum + item.revenue,
      0
    );
    const commissions = marketplaceItems.reduce(
  ...
  const getCreatorTier = (sales: number) => {
    return (
      commissionTiers.find(
        tier =>
          sales >= tier.minSales &&
          (tier.maxSales === -1 || sales <= tier.maxSales)
      ) || commissionTiers[0]
    );
  };
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='mt-1 text-gray-600'>
            Manage marketplace items, commissions, and creator payouts
          </p>
        </div>
      ...
      <div className='grid grid-cols-1 gap-4 md:grid-cols-4'>
          ...
          <CardContent className='p-6'>
            ...
            <div className='mt-2'>
              <div className='text-sm text-gray-600'>
                {((totalCommissions / totalRevenue) * 100).toFixed(1)}% of
                revenue
              </div>
            </div>
          </CardContent>
        ...
        <Card>
          <CardContent className='p-6'>
            ...
            <div className='mt-2'>
              <div className='text-sm text-gray-600'>
                {((platformRevenue / totalRevenue) * 100).toFixed(1)}% of
                revenue
              </div>
            </div>
          </CardContent>
                  ...
                  <div key={tier.id} className='rounded-lg border p-4'>
                    <div className='mb-4 flex items-center justify-between'>
                      <div className='flex items-center gap-3'>
                        <div
                          className={`h-8 w-8 ${tier.color} flex items-center justify-center rounded-lg text-white`}
                        >
                    ...
                    <div className='flex items-center gap-2'>
                      <div className='h-2 w-20 rounded-full bg-gray-200'>
                        <div
                          ...
                          style={{
                            width: `${(totalCommissions / totalRevenue) * 100}%`,
                          }}
                        />
                      </div>
                    ...
                    <div className='flex items-center gap-2'>
                      <div className='h-2 w-20 rounded-full bg-gray-200'>
                        <div
                          ...
                          style={{
                            width: `${(platformRevenue / totalRevenue) * 100}%`,
                          }}
                        />
                      </div>
                      <span className='w-16 text-right text-sm font-medium'>
