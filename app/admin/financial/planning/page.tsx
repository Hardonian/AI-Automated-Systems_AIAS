    ...
    return (
      <AdminLayout>
        <Alert variant='destructive'>
          ...
          <AlertDescription>
            Financial Admin access is required to view business planning
            documents. Please contact a system administrator.
          </AlertDescription>
        </Alert>
      </AdminLayout>
    );
    ...
    <AdminLayout requireFinancialAccess={true}>
      <div className='space-y-6'>
        ...
        <Alert>
          ...
          <AlertDescription>
            All documents in this section are encrypted with git-crypt and
            stored in internal/private/ directories. Access is restricted to
            Financial Admins only. Documents are decrypted on-demand when
            accessed.
          </AlertDescription>
        </Alert>
        ...
        <Card>
          ...
          <CardContent>
            <div className='space-y-2 text-sm'>
              <p>
                <strong>Storage:</strong> Documents are stored in encrypted
                directories:
              </p>
              ...
              <p>
                <strong>Access:</strong> Financial Admin or Super Admin role
                required
              </p>
              <p>
                <strong>API:</strong> /api/admin/financial/planning/*,
                /api/admin/financial/investor/*, /api/admin/financial/yc/*
              </p>
              <p className='mt-4 text-muted-foreground'>
                <strong>Note:</strong> Access modules (lib/admin/*) are visible
                in the repo for IP protection, but actual document data is
                encrypted.
              </p>
            </div>
          </CardContent>
