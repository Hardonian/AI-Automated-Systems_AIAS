...
const capabilityMap = [
  ...
  },
  {
    ...
    points: [
      ...
      "Deterministic routing before execution",
      "Fallback and human review paths",
    ],
  },
  {
    title: "Eval + RAG",
    points: [
      "Evaluation integrity scorecards",
  ...
  },
  {
    ...
    points: [
      ...
      "Proposal and scope acceleration",
      "Conversion loop instrumentation",
    ],
  },
  {
    title: "Ops Autopilot",
    points: [
      "Exception triage and response",
      "Incident replay and postmortems",
...
const engagements = [
  {
    name: "Diagnostic",
    description:
      "Rapid system diagnosis to map failure modes, governance gaps, and ROI opportunities.",
  },
  {
    name: "Architecture Sprint",
    description:
      "Time-boxed design sprint for control-plane boundaries, orchestration flows, and rollout criteria.",
  },
  {
    name: "Control-Plane Implementation",
    description:
      "Build and deploy deterministic controls around multi-model, multi-agent workflows.",
  },
  {
    name: "Agent Fleet Stabilization",
    description:
      "Stabilize production agents with evaluation hardening, cost controls, and operating playbooks.",
  },
];
      ...
      <PageSection background="muted">
        <SurfaceCard>
          ...
          <p className="mt-3 text-muted-foreground">
            Simple architecture view of how governance and orchestration map
            into growth and operations autopilot loops.
          </p>
          <div className="mt-6 overflow-hidden rounded-xl border bg-slate-950 p-4 text-slate-100">
            <svg
              ...
              role="img"
              aria-label="AIAS control-plane architecture diagram"
            >
              <rect width="960" height="420" rx="24" fill="#0B1020" />
              <text x="40" y="48" fill="#E5E7EB" fontSize="22" fontWeight="700">
                AIAS Control-Plane Architecture
              </text>
              <text x="40" y="72" fill="#9CA3AF" fontSize="13">
                Deterministic governance governs execution, eval integrity, and
                cost controls.
              </text>
              <rect
                x="36"
