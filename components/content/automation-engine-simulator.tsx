...
const SCENARIOS: Record<ScenarioKey, ScenarioConfig> = {
  "lead-qualification": {
    ...
    stages: [
      {
        ...
        type: "deterministic",
        description: "Strict Zod contract validation and deduplication",
      },
      {
        id: "enrich",
        name: "Context Retrieval & Scoring",
        type: "ai-assisted",
        description: "Model-assisted entity extraction & risk matrix analysis",
      },
      {
        id: "gate",
        name: "Policy & Guardrail Gate",
        type: "deterministic",
        description:
          "Deterministic budget, governance, and scope boundary checks",
      },
      {
        id: "dispatch",
        name: "Runbook Dispatch",
        type: "deterministic",
        description: "Generates structured brief, routes to partner queue",
      },
    ],
    normalOutput: {
      artifact: {
      ...
      policyChecks: [
        {
          name: "Schema Conformance (Zod)",
          status: "passed",
          detail: "All 7 mandatory fields matched exact contracts",
        },
        {
          name: "Pricing Guardrail Verification",
          status: "passed",
          detail: "Zero forbidden per-hour/token rates detected",
        },
        {
          name: "Data Residency Boundary",
          status: "passed",
          detail: "Canadian sovereignty requirement enforced (PIPEDA)",
        },
        {
          name: "Routing Threshold Match",
          status: "passed",
          detail: "Complexity index 44.2 matches Co-Build tier criteria",
        },
      ],
      logs: [
    ...
    fallbackOutput: {
      artifact: {
        ...
        reason:
          "Unverified multi-tenant data boundary detected in RFP pipeline",
      ...
      policyChecks: [
        {
          name: "Schema Conformance (Zod)",
          status: "passed",
          detail: "Payload syntactically valid",
        },
        {
          name: "Data Boundary Isolation Gate",
          status: "failed",
          detail: "Multi-tenant isolation requires human architect signoff",
        },
        {
          name: "Automatic Dispatch Block",
          status: "warning",
          detail: "Automated dispatch halted by Policy Rule #14",
        },
      ],
      logs: [
  ...
  "invoice-audit": {
    ...
    badge: "FinOps",
    description:
      "Performs deterministic multi-currency line-item verification, GL code matching, and variance guardrails.",
    inputPayload: {
    ...
    stages: [
      {
        ...
        type: "deterministic",
        description: "Deterministic optical & PDF payload ingestion",
      },
      {
        id: "reconcile",
        name: "GL Mapping & Extraction",
        type: "ai-assisted",
        description: "Model entity extraction & ledger categorization",
      },
      {
        id: "verify",
        name: "Tolerance & Variance Gate",
        type: "deterministic",
        description: "Deterministic math check: variance <= 1.0% limit",
      },
      {
        id: "audit",
        name: "Ledger Audit Ledger",
        type: "deterministic",
        description: "Signs cryptographic verification receipt",
      },
    ],
    normalOutput: {
      artifact: {
      ...
      policyChecks: [
        {
          name: "Line-Item Mathematical Parity",
          status: "passed",
          detail: "Sum of 18 items exactly equals $34,250.00",
        },
        {
          name: "Tax Formula Conformance (HST/GST)",
          status: "passed",
          detail: "13.00% tax calculation verified to 4 decimal places",
        },
        {
          name: "Budget Cap Allocation Gate",
          status: "passed",
          detail: "Cost Center CC-AI-INFRA-400 has $82k remaining budget",
        },
      ],
      logs: [
    ...
    fallbackOutput: {
      artifact: {
        ...
        flaggedAction:
          "Payment frozen; notification sent to procurement officer",
      },
      policyChecks: [
        {
          name: "Mathematical Parity Check",
          status: "passed",
          detail: "Line items sum correctly",
        },
        {
          name: "Purchase Order Matching",
          status: "failed",
          detail: "Invoice exceeds signed PO ceiling by $1,644.00 CAD",
        },
        {
          name: "Auto-Pay FinOps Safety Gate",
          status: "failed",
          detail: "Variance > 1.0% limit halted transaction",
        },
      ],
      logs: [
  ...
  "governance-gate": {
    ...
    badge: "AI Safety",
    description:
      "Evaluates model output before production commit, detecting hallucinations, PII leakage, and schema drift.",
    inputPayload: {
    ...
    stages: [
      {
        ...
        type: "deterministic",
        description: "Runs regression suite across 240 benchmark assertions",
      },
      {
        id: "semantic",
        name: "Semantic Boundary Check",
        type: "ai-assisted",
        description: "Multi-model cross-eval & factual grounding verification",
      },
      {
        id: "pii",
        name: "PII & Security Gate",
        type: "deterministic",
        description:
          "Deterministic regex & entropy scan for sensitive credentials",
      },
      {
        id: "commit",
        name: "Production Gateway",
        type: "deterministic",
        description: "Deterministic promotion or immediate canary rollback",
      },
    ],
    normalOutput: {
      artifact: {
      ...
      policyChecks: [
        {
          name: "Benchmark Eval Threshold",
          status: "passed",
          detail: "99.17% pass rate exceeds 98.0% requirement",
        },
        {
          name: "Zero-PII Leakage Assertion",
          status: "passed",
          detail: "Scanned 48,000 output tokens without sensitive matches",
        },
        {
          name: "Cost Ceiling Constraint",
          status: "passed",
          detail: "Inference rate stayed within $0.018/query allocation",
        },
      ],
      logs: [
      ...
      policyChecks: [
        {
          name: "Benchmark Eval Threshold",
          status: "failed",
          detail: "93.75% falls below mandatory 98.0% gate",
        },
        {
          name: "Hallucination Detection Gate",
          status: "failed",
          detail: "Grounding index 0.812 triggered safety intercept",
        },
        {
          name: "Automated Rollback Rule #4",
          status: "passed",
          detail: "Rollback initiated in 12ms; production unaffected",
        },
      ],
      logs: [
  ...
  "support-triage": {
    ...
    badge: "Customer Ops",
    description:
      "Deterministic ticket classification, SLA countdown monitoring, and AI draft generation with human verification.",
    inputPayload: {
    ...
    stages: [
      {
        ...
        name: "SLA Triage",
        type: "deterministic",
        description: "Deterministic priority scoring & SLA timer lock",
      },
      {
        id: "draft",
        name: "Root-Cause & Draft Response",
        type: "ai-assisted",
        description: "System log synthesis & structured resolution draft",
      },
      {
        id: "safety",
        name: "Contract & Tone Check",
        type: "deterministic",
        description: "Verifies no binding legal commitments in draft",
      },
      {
        id: "route",
        name: "Human-in-the-Loop Dispatch",
        type: "deterministic",
        description: "Queues to senior engineer with 1-click approve",
      },
    ],
    normalOutput: {
      artifact: {
        ...
        generatedDiagnostic:
          "Endpoint returned HTTP 504 gateway timeout due to TLS renegotiation",
        suggestedFix:
          "Update webhook client timeout to 8000ms & renew cert chain",
        slaConfidence: "Response queued with 14m remaining",
      },
      policyChecks: [
        {
          name: "SLA Time-Lock Guardrail",
          status: "passed",
          detail: "Escalation triggered within 30 seconds of ticket receipt",
        },
        {
          name: "Legal Commitment Filter",
          status: "passed",
          detail: "Zero unauthorized compensation claims in proposed draft",
        },
        {
          name: "Required Human Signoff Gate",
          status: "passed",
          detail: "Direct delivery blocked until engineer presses Confirm",
        },
      ],
      logs: [
    ...
    fallbackOutput: {
      artifact: {
        ...
        escalationReason:
          "SLA < 10m threshold reached + System Outage detected",
        onCallPaged: "DevOps Primary On-Call (SMS + PagerDuty)",
        fallbackAction:
          "Sent automated acknowledgement to client with live status page link",
      },
      policyChecks: [
        {
          name: "Critical SLA Breached",
          status: "warning",
          detail: "Time-to-breach < 10 mins triggered fast-path escalation",
        },
        {
          name: "PagerDuty Integration Gate",
          status: "passed",
          detail: "Direct engineer alert dispatched successfully",
        },
      ],
      logs: [
...
export function AutomationEngineSimulator() {
  const [selectedScenarioKey, setSelectedScenarioKey] =
    useState<ScenarioKey>("lead-qualification");
  const [simulateFailure, setSimulateFailure] = useState(false);
  const [isRunning, setIsRunning] = useState(false);
  const [currentStageIndex, setCurrentStageIndex] = useState(-1);
  const [activeTab, setActiveTab] = useState<
    "visual" | "logs" | "artifact" | "guardrails"
  >("visual");
  ...
  const activeData = simulateFailure
    ? scenario.fallbackOutput
    : scenario.normalOutput;
      ...
      if (stage < scenario.stages.length) {
        ...
        if (activeData.logs[stage]) {
          setDisplayedLogs((prev) => [
            ...prev,
            activeData.logs[stage] as string,
          ]);
        }
      } else {
  ...
  const handleDownloadRunbook = () => {
    const runbook = {
      ...
      mode: simulateFailure
        ? "FAILURE_RECOVERY_SIMULATION"
        : "DETERMINISTIC_SUCCESS_RUN",
    ...
    const blob = new Blob([JSON.stringify(runbook, null, 2)], {
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Test how deterministic guardrails and AI layers interact with full
            observability and zero hard failures.
          </p>
        </div>
          ...
          <SurfaceCard className="p-6 border-2 border-border">
            ...
            <div className="mt-6 space-y-4">
              {scenario.stages.map((stage, idx) => {
                const isPassed =
                  completed || (isRunning && currentStageIndex > idx);
                const isCurrent = isRunning && currentStageIndex === idx;
                const isUpcoming =
                  !isRunning && !completed && currentStageIndex < idx;
                ...
                <div className="space-y-4">
                  ...
                  {completed && (
                    <div className="rounded-none border-2 border-primary bg-primary/10 p-3">
                      ...
                      <p className="mt-1 text-xs text-muted-foreground">
                        Deterministic contracts ensured all execution boundaries
                        remained within defined tolerances.
                      </p>
                    </div>
                  )}
                </div>
                  ...
                  <div className="h-72 overflow-auto border-2 border-border bg-black p-3 font-mono text-xs text-emerald-400 space-y-1.5">
                    {displayedLogs.length === 0 ? (
                      <p className="text-zinc-500 italic">
                        Click &quot;Run Simulation&quot; to stream runtime
                        telemetry...
                      </p>
                    ) : (
