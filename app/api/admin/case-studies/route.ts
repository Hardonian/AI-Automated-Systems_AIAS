...
export async function GET(request: NextRequest) {
  return createGETHandler(async () => {
    ...
    const caseStudies: CaseStudy[] = [
      {
        id: 'cs_001',
        title:
          'How Acme E-commerce Saved 20 Hours Per Week with AI Automated Systems',
        ...
        challenge: {
          background:
            'Acme E-commerce is a growing online retailer processing 500+ orders per day.',
          problems: [
        ...
        testimonial: {
          quote:
            'AIAS Platform saved us 15 hours per week and $18,000 per year. The ROI was immediate and the platform is incredibly easy to use.',
          author: 'John Smith',
    ...
    const byIndustry = caseStudies.reduce(
      (acc, cs) => {
