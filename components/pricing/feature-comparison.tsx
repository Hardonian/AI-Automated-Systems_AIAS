  ...
  return (
    <Card className='mt-12'>
      <CardHeader>
        ...
        <CardDescription>
          Compare plans to find the right fit for your business. All plans
      ...
      <CardContent>
              ...
              {features.map((category, categoryIdx) => (
                <React.Fragment key={categoryIdx}>
                  <tr className='bg-muted/50'>
                    <td className='p-3 text-sm font-semibold' colSpan={4}>
                      {category.category}
                    </td>
                  </tr>
        ...
        <div className='mt-6 rounded-lg border border-amber-200 bg-amber-50 p-4 dark:border-amber-800 dark:bg-amber-950/20'>
          <p className='text-sm text-amber-900 dark:text-amber-100'>
            <strong>Note:</strong> Starter and Pro plans are in Beta. Some
            features are in active development. Features marked "Coming Soon"
