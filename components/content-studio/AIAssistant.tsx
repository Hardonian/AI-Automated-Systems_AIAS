  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          'AI has generated new content. Review and apply if you like it.',
      });
    } catch (error: any) {
      toast({
      ...
      <CardContent className='space-y-4'>
        ...
        {seoSuggestions && (
          <div className='rounded-lg bg-muted p-4'>
            <h4 className='mb-2 font-semibold'>SEO Suggestions:</h4>
            <p className='whitespace-pre-wrap text-sm'>{seoSuggestions}</p>
          </div>
        )}
      </CardContent>
    </Card>
