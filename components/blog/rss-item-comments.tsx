    ...
    <section className="mt-12">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Share your thoughts on this news. All comments are moderated by AI using systems thinking principles 
          ...
          <div className="space-y-4 mt-8">
            ...
            {comments.filter(c => c.status === "approved").length === 0 ? (
              <p className="text-muted-foreground text-sm">
                No comments yet. Be the first to share your systems thinking perspective!
              </p>
            ) : (
              comments
