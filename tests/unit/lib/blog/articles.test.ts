...
import { getFeaturedArticles, getLatestArticles, getArticleBySlug } from '../../../../lib/blog/articles';
...
expect(date1).toBeGreaterThan(date2);
  ...
  describe('getArticleBySlug', () => {
    it('should return the correct article for a valid slug', () => {
      ...
      expect(article?.title).toBe('Systems Thinking: The Key to Scaling AI Safely');
