      ...
      <div className={getContainerClasses('wide')}>
        ...
        >
          ...
          <motion.p
            ...
            whileInView={{ opacity: 1, y: 0 }}
            className={
              `text-center text-muted-foreground ${TYPOGRAPHY.body}`
            }
          >
        ...
        >
          <motion.h3
            ...
            viewport={{ once: true }}
            whileInView={{ opacity: 1, y: 0 }}
            className={`${TYPOGRAPHY.h3} text-center mb-8`}
          >
          ...
          <motion.p
            ...
            whileInView={{ opacity: 1, y: 0 }}
            className={
              `text-center text-muted-foreground ${TYPOGRAPHY.body} mb-8`
            }
          >
        ...
        >
          <motion.h4
            ...
            viewport={{ once: true }}
            whileInView={{ opacity: 1, y: 0 }}
            className={`${TYPOGRAPHY.h4} text-center mb-6`}
          >
