...
export const heroTemplates = {
  saas: {
    ...
    description:
      'Join thousands of businesses using AI to automate workflows and drive growth.',
  ...
  enterprise: {
    ...
    description:
      'Powerful tools designed for large organizations with complex needs.',
...
export const testimonialTemplates = [
  {
    quote:
      'This platform has transformed how we work. The time savings alone have been incredible.',
  ...
  {
    quote:
      "The best investment we've made this year. ROI was immediate and continues to grow.",
    author: 'Michael Chen',
    role: 'CEO',
    company: 'Growth Co.',
    rating: 5,
  ...
  pricing: [
    {
      ...
      answer:
        'Our free plan includes basic features, up to 100 actions per month, and email support.',
    },
    {
  ...
  features: [
    {
      ...
      answer:
        'Yes, we provide comprehensive REST APIs for all plans, with additional features for enterprise customers.',
    },
    {
      question: 'What integrations are available?',
      answer:
        'We support 100+ integrations including popular tools like Slack, Salesforce, and Zapier.',
    },
  ],
};
