  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Help us refine our positioning. Your feedback directly impacts our
          clarity.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className='space-y-4'>
          <div className='space-y-2'>
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value='solution_clarity'>
                  Solution Clarity
                </SelectItem>
          ...
          <div className='space-y-2'>
            ...
            <p className='text-xs text-muted-foreground'>
              More detailed feedback earns higher impact scores and helps us
              improve faster.
            </p>
          </div>
