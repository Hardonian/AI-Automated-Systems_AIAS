    ...
    <>
      ...
      <PageSection>
        <p className="mb-6 max-w-3xl text-sm text-muted-foreground">
          AIAS helps teams that need measurable reliability and governance
          improvements from AI-enabled operations. These representative
          engagement scenarios show how discovery-first planning translates into
          faster throughput and tighter control. Outcomes are framed around
          operational metrics, not vanity adoption numbers.
        </p>
