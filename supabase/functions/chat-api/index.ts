...
serve(async req => {
  ...
  try {
    ...
    if (!openaiApiKey) {
      ...
      aiResponse =
        "I'm your AI automation assistant. OpenAI API key is not configured. Please set OPENAI_API_KEY environment variable.";
    } else {
      try {
        ...
        const messages: Array<{
        ...
        }> = [
          {
            role: 'system',
            content:
              'You are a helpful AI automation assistant. You help users build workflows, automate tasks, and solve business problems using AI and automation tools.',
          },
        ];
