...
import { ArrowRight, CheckCircle2, Zap, Workflow, Layers, Shield, Clock } from 'lucide-react';
...
const workflowFeatures = [
  {
    ...
    description: 'AI agents that handle triage, routing, and decision support with clear escalation paths.',
  },
  {
    icon: Workflow,
    title: 'Visual Workflow Design',
    description: 'Map complex business processes with intuitive drag-and-drop workflow builders.',
  },
  {
    icon: Layers,
    title: 'Multi-Step Orchestration',
    description: 'Chain together APIs, databases, and AI models into coherent operational sequences.',
  },
  {
    icon: Shield,
    title: 'Governance & Guardrails',
    description: 'Built-in policy enforcement, audit trails, and human-in-the-loop checkpoints.',
  },
  {
    icon: Clock,
    title: 'Reliable Execution',
    description: 'Deterministic execution with retry logic, error handling, and operational visibility.',
  },
  {
    icon: CheckCircle2,
    title: 'Quick Wins First',
    description: 'Identify and automate high-ROI workflows within days, not months.',
  },
];
...
const workflowTypes = [
  {
    ...
    description: 'Intelligent ticket routing, sentiment analysis, and automated response drafting.',
    outcome: 'Reduce response time by 60-80%',
  },
  {
    title: 'Document Processing',
    description: 'Extract, classify, and route documents with AI-powered OCR and NLP.',
    ...
    <>
      ...
      <PageSection>
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {workflowFeatures.map((feature) => (
            <SurfaceCard key={feature.title} className="p-6 transition-all duration-300 hover:shadow-lg hover:scale-[1.02]">
      ...
      <PageSection background="muted">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {workflowTypes.map((type) => (
            <SurfaceCard key={type.title} className="p-6 transition-all duration-300 hover:shadow-lg">
      ...
      <PageSection width="narrow">
        <SurfaceCard className="text-center p-8">
          <h2 className="text-2xl font-bold">Ready to automate your first workflow?</h2>
          <p className="mt-4 text-muted-foreground max-w-xl mx-auto">
            Schedule a free 30-minute discovery call. We will map your current process, 
            identify quick wins, and recommend the right automation approach.
          </p>
