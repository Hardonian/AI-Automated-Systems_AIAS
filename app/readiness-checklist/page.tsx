        ...
        <div className="max-w-4xl mx-auto grid gap-6 md:grid-cols-2">
          <SurfaceCard className="border-2 border-border p-6 flex flex-col justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                Download the raw checklist in markdown format for local
                repository storage, CI/CD policy tracking, or internal team
                audits.
              </p>
            </div>
            <div className="mt-6 pt-4 border-t-2 border-border">
              <Button
                asChild
                variant="outline"
                className="w-full rounded-none border-2 border-border font-mono text-xs font-bold uppercase tracking-wider hover:border-foreground"
              >
          ...
          <SurfaceCard className="border-2 border-border p-6 flex flex-col justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                Prefer async feedback? Send your stack notes and failure modes
                directly to our lead architects for asynchronous review.
              </p>
            </div>
            <div className="mt-6 pt-4 border-t-2 border-border">
              <Button
              ...
              >
                <a
                  href={`mailto:${siteContent.contact.email}?subject=${subject}&body=${body}`}
                >
                  Email Stack Snapshot
                </a>
              </Button>
