        ...
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="mt-4 text-4xl font-bold md:text-5xl">
              From discovery to dependable delivery
            </h1>
            <p className="mt-4 text-lg text-muted-foreground">
              We run a practical, low-risk delivery model: map the workflow,
              ship a scoped pilot, then scale with governance and measurable
              outcomes.
            </p>
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
          ...
          <div className="sticky top-24 rounded-2xl border bg-card p-6">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Every engagement uses deterministic checkpoints for quality,
              safety, and handoff readiness.
            </p>
            <div className="mt-6">
              <WorkflowDiagram />
            </div>
        ...
        <div className="container">
          <div className="mx-auto max-w-2xl rounded-2xl border bg-card p-8 text-center md:p-12">
            <h2 className="text-2xl font-bold md:text-3xl">
              Ready to map your first automation workflow?
            </h2>
            <p className="mt-4 text-muted-foreground">
              Book a free 30-minute consult and we will identify the
              highest-leverage workflow to launch first.
            </p>
            <a
