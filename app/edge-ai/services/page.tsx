...
export const metadata: Metadata = {
  ...
  description:
    'Edge AI consulting services: optimization, deployment, NPU integration, and custom implementations for your business.',
};
...
const services = [
  {
    ...
    description:
      "Get started with edge AI optimization. We'll review your models, discuss target devices, and create an optimization strategy.",
    deliverables: [
  ...
  },
  {
    ...
    description:
      'Comprehensive deployment strategy for enterprise edge AI. Architecture, security, monitoring, and scaling.',
    deliverables: [
  ...
  },
  {
    ...
    description:
      'Deploy offline AI agents with NPU acceleration. Perfect for mobile apps, IoT devices, and edge servers.',
    deliverables: [
  ...
  },
  {
    ...
    description:
      'Expert model compression to reduce size by 70-90% while maintaining accuracy. Custom quantization strategies.',
    deliverables: [
  ...
  },
  {
    ...
    description:
      'End-to-end deployment service for specific platforms. From optimization to production deployment.',
    deliverables: [
  ...
  },
  {
    ...
    description:
      'Deploy local AI assistants for education, customer support, or internal tools. Works completely offline.',
    deliverables: [
    ...
    <div className='container py-12 md:py-16'>
      ...
      <div className='rounded-lg bg-muted/50 p-8 text-center'>
        ...
        <p className='mb-6 text-muted-foreground'>
          Schedule a free consultation to discuss your edge AI needs. We'll help
          you choose the right service and create a custom plan.
        </p>
        <div className='flex flex-col justify-center gap-4 sm:flex-row'>
          <Button asChild size='lg'>
