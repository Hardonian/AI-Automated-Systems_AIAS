...
function getBaseUrl(): string {
  ...
  // Try Vite environment variables safely without eval
  try {
    // Use globalThis to safely check for import.meta
    const globalObj = typeof globalThis !== 'undefined' ? globalThis : {};
    // Check for Vite's import.meta.env via feature detection
    const viteEnv = (globalObj as Record<string, unknown>).__VITE__ENV__;
    if (viteEnv && typeof viteEnv === 'object') {
      const env = viteEnv as Record<string, string>;
      return (
        env.VITE_APP_URL ||
...
export const PAGE_SEO: PageSEO = {
  home: {
    ...
    description:
      'Transform your business with custom AI agents and intelligent automation. Enterprise-grade AI consultancy specializing in workflow automation, AI implementation, and digital transformation.',
    keywords: [
      'AI consultancy',
      'AI automation',
    ...
    ogDescription:
      'Transform your business with custom AI agents and intelligent automation. Expert AI consultancy for enterprise digital transformation.',
  ...
  services: {
    ...
    description:
      'Comprehensive AI consulting services including custom AI agent development, workflow automation, and enterprise AI implementation. Expert guidance for your digital transformation.',
    keywords: [
      'AI consulting services',
      'custom AI solutions',
      'AI implementation',
    ...
    ogDescription:
      'Expert AI consulting services for custom AI solutions, workflow automation, and enterprise implementation.',
    ...
    structuredData: {
      ...
      description:
        'Comprehensive AI consulting services for enterprise digital transformation.',
  ...
  pricing: {
    ...
    description:
      'Transparent pricing for AI consulting services. Choose from flexible plans for AI automation, custom AI solutions, and enterprise AI implementation.',
    keywords: [
    ...
    ogDescription:
      'Transparent pricing for AI consulting services. Flexible plans for AI automation and custom solutions.',
  ...
  caseStudies: {
    ...
    description:
      'Explore real-world AI implementation success stories and case studies. See how businesses transformed with our AI consulting services.',
    keywords: [
      'AI case studies',
      'AI success stories',
    ...
    ogDescription:
      'Real-world AI implementation success stories and case studies from our consulting projects.',
  ...
  platform: {
    ...
    description:
      'Build and deploy AI workflows with our self-service platform. No-code AI automation tools for businesses of all sizes.',
    keywords: [
    ...
    ogDescription:
      'Build and deploy AI workflows with our self-service platform. No-code AI automation tools.',
...
export const generatePageTitle = (
  ...
  const pageTitles: Record<string, string> = {
    ...
    caseStudies:
      'AI Success Stories | Real-World AI Implementation Case Studies',
...
export const generateMetaDescription = (page: string): string => {
  const descriptions: Record<string, string> = {
    ...
    platform:
      'Build and deploy AI workflows with our self-service platform. No-code AI automation tools for businesses of all sizes.',
    about:
      'Learn about AIAS, the leading AI consultancy specializing in enterprise automation, custom AI solutions, and digital transformation.',
    contact:
      'Get in touch with AIAS for AI consulting services. Start your AI automation journey with expert guidance and support.',
    blog: 'Stay updated with the latest AI insights, automation tips, and industry trends from AIAS experts.',
    partners:
      'Join the AIAS partner program and help businesses transform with AI automation. Earn commissions and grow with us.',
  };

  return (
    descriptions[page] || 'AIAS - AI Agent Solutions for Enterprise Automation'
  );
};
