...
export const AutomationDashboard: React.FC = () => {
    ...
    const sampleWorkflows: AutomationWorkflow[] = [
      {
        ...
        trigger: {
          ...
          config: { url: '', method: 'POST' as const },
        },
        steps: [],
        status: 'active',
  ...
  const categories = [
    { id: 'all', label: 'All', count: workflows.length },
    {
      ...
      count: workflows.filter(w => w.category === 'lead_generation').length,
    },
    {
      id: 'appointment_booking',
      label: 'Appointment Booking',
      count: workflows.filter(w => w.category === 'appointment_booking').length,
    },
    {
      id: 'note_taking',
      label: 'Note Taking',
      count: workflows.filter(w => w.category === 'note_taking').length,
    },
    {
      id: 'sketching',
      label: 'Sketching',
      count: workflows.filter(w => w.category === 'sketching').length,
    },
    {
      id: 'admin',
      label: 'Admin',
      count: workflows.filter(w => w.category === 'admin').length,
    },
  ];
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='mt-2 text-gray-600'>
            Intelligent backend automation and AI-powered workflows
          </p>
        </div>
            ...
            <CardContent className='p-6'>
              <div className='flex items-center justify-between'>
                <div>
                  ...
                  <p className='text-sm text-gray-500'>
                    Average execution time: {metrics.averageExecutionTime}s
                  </p>
                </div>
                  ...
                  <div className='flex items-start justify-between'>
                    <div className='flex items-center gap-3'>
                      <div className='rounded-lg bg-blue-50 p-2'>
                        {workflow.category === 'lead_generation' && (
                          <Users className='h-6 w-6 text-blue-600' />
                        )}
                        {workflow.category === 'appointment_booking' && (
                          <Calendar className='h-6 w-6 text-green-600' />
                        )}
                        {workflow.category === 'note_taking' && (
                          <FileText className='h-6 w-6 text-purple-600' />
                        )}
                        {workflow.category === 'sketching' && (
