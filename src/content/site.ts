  ...
  caseStudies: [
    {
      ...
      results: ['40% fewer manual coordination touches', 'GTM launch cadence cut from 3 weeks to 5 days', 'Standardized playbooks adopted across 3 teams'],
    ...
    },
    {
      ...
      results: ['Automation backlog prioritized to 12 high-impact workflows', '60% improvement in delivery confidence scores', 'Cross-team alignment achieved in under 2 weeks'],
    ...
    privacy: {
      ...
      sections: [
        ...
        },
        {
          heading: 'Your Rights',
          body:
            'You can request access, updates, or deletion of your information by emailing inquiries@aiautomatedsystems.ca.',
        },
      ],
    },
    terms: {
