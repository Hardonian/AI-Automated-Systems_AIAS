...
export function PerformanceHUD() {
  ...
  return (
    <div className='fixed bottom-4 right-4 z-50 rounded-lg border border-border bg-card p-4 font-mono text-xs shadow-lg'>
      <div className='mb-2 font-bold'>Performance HUD</div>
      <div className='space-y-1'>
        <div
          className={cn(
            'flex justify-between gap-4',
            lcpGood ? 'text-green-600' : 'text-red-600'
          )}
        >
          <span>LCP:</span>
        ...
        <div
          className={cn(
            'flex justify-between gap-4',
            clsGood ? 'text-green-600' : 'text-red-600'
          )}
        >
          <span>CLS:</span>
