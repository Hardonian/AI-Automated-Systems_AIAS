        ...
        <div className='grid gap-8 lg:grid-cols-[1.4fr_1fr]'>
          <SurfaceCard>
            ...
            <p className='mt-4 text-muted-foreground'>
              We combine technical implementation with operator-ready documentation. Every engagement
              is designed so your team can maintain and improve the system after handoff.
            </p>
          ...
          {[
            {
              ...
              description: 'Controls and escalation paths are defined before volume increases.',
            },
            {
              icon: Users,
              title: 'Human-in-the-loop',
              description: 'Operators keep oversight at high-risk and low-confidence decision points.',
            },
            {
              icon: MapPin,
              title: 'Operator enablement',
              description: 'Runbooks and training are included so adoption is sustainable.',
            },
          ].map(item => (
