...
const capabilities = [
  {
    ...
    description: 'Workflow mapping, risk scoring, and baseline KPI capture before implementation.',
    href: '/approach',
  },
  {
    title: 'Deterministic automation',
    description: 'Rule-based orchestration with predictable routing, guardrails, and retry policy.',
    href: '/services/automation-web',
  },
  {
    title: 'AI augmentation layer',
    description: 'Scoped agentic assistance for classification, drafting, and triage acceleration.',
    href: '/services/app-ai-systems',
  },
  {
    title: 'Governance & handoff',
    description: 'Audit logs, runbooks, QA controls, and measured rollout to production teams.',
    href: '/how-it-works',
  },
];
