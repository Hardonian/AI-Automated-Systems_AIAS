...
const articles: BlogArticle[] = [
    ...
    },
    {
        ...
        title: 'We Launched the ComfyUI Workflow Pack — 11 Production Workflows, Yours to Own',
        excerpt: 'A local-first bundle of 11 battle-tested ComfyUI workflows for portrait, product, and concept generation. No subscriptions, no cloud lock-in, no token meters. Buy once, run forever on hardware you control.',
...
[Get the ComfyUI Workflow Pack →](https://aiautomatedsystems.ca/p/comfyui-workflow-pack)`,
        ...
        author: 'AIAS Team',
        tags: ['comfyui', 'local-first', 'sovereign-ai', 'image-generation', 'workflows'],
        systemsThinking: false,
        genAIContentEngine: false,
        seoKeywords: ['comfyui workflows', 'local AI image generation', 'private comfyui', 'buy comfyui workflows', 'sovereign AI'],
    },
];
