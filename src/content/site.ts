...
const rawSiteContent: SiteConfig = {
  ...
  positioning: {
    ...
    badgeText: '',
    impactCardsLabel: 'What changes after we work together',
    primaryCTA: {
      label: 'Book a Call',
    ...
    socialProof: [
      { icon: 'clock', text: '42s median lead triage — down from 3+ minutes' },
      { icon: 'shield', text: '99.2% workflow success rate in production' },
      { icon: 'zap', text: '78% faster intake-to-action on qualified leads' },
      { icon: 'check', text: 'Every run logged, replayable, and auditable' },
    ],
    trustBadges: [
      { icon: 'shield', text: 'SOC 2-aligned controls' },
      { icon: 'globe', text: 'Canadian operations, global delivery' },
