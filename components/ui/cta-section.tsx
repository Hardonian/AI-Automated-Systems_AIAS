    ...
    >
      ...
      <div className='relative z-10'>
        <motion.h2
          ...
          {...({
            className:
              'text-3xl md:text-4xl font-bold tracking-tight mb-4 bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent',
          } as any)}
        >
          {title}
        </motion.h2>
        ...
        {valueProps.length > 0 && (
          ...
          >
            {valueProps.map((prop, i) => (
              ...
              >
                <div className='mt-0.5 text-primary'>{prop.icon}</div>
