        ...
        <Card>
          <CardContent className='pb-12 pt-12 text-center'>
            ...
            <p className='mb-6 text-muted-foreground'>
              Thank you for your interest in the AIAS Beta Program. We&apos;ll
              review your application and get back to you within 1-2 weeks.
            </p>
            <Button asChild>
  ...
  return (
    <div className='container mx-auto max-w-2xl px-4 py-16'>
      <div className='mb-8 text-center'>
        <h1 className='mb-4 text-4xl font-bold'>Join the AIAS Beta Program</h1>
        <p className='text-xl text-muted-foreground'>
          Get early access to intelligent automation and help shape the future
          of AIAS
        </p>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <form className='space-y-6' onSubmit={handleSubmit}>
            ...
            <div className='space-y-4'>
              <div className='flex items-start space-x-2'>
                ...
                <Label className='text-sm leading-relaxed' htmlFor='commitment'>
                  I commit to using the platform regularly and providing
              ...
              <div className='flex items-start space-x-2'>
                ...
                <Label className='text-sm leading-relaxed' htmlFor='feedback'>
                  I&apos;m willing to participate in feedback sessions and
                  surveys
                </Label>
              </div>
            </div>
            ...
            <Button
              className='w-full'
              disabled={submitting || !formData.commitment}
              type='submit'
            >
              {submitting ? (
                <>
