...
export default function ResultsPage() {
  ...
  return (
    <div className='container mx-auto space-y-6 p-6'>
      <div>
        <h1 className='mb-2 text-3xl font-bold'>Test Your Workflow</h1>
      ...
      {execution && execution.status === 'failed' && (
        <Card className='border-yellow-500'>
          <CardHeader>
            ...
            <CardDescription>
              Your workflow was created but the test run encountered some
              issues. You can still proceed and fix it later.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button
