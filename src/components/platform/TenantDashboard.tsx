      ...
      <div className='flex items-center justify-between'>
        <div className='flex items-center gap-4'>
          ...
          <div>
            ...
            <p className='text-gray-600'>
              Professional Plan • {tenant.subdomain}.aias.com
            </p>
          </div>
        </div>
          ...
          <CardContent className='p-6'>
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-3xl font-bold text-gray-900'>
                  {(usage?.executions || 0).toLocaleString()}
                </p>
                <p className='text-sm text-gray-500'>
              ...
              <CardContent>
                <div className='space-y-4'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div className='flex-1'>
                      <p className='text-sm font-medium'>
                        Workflow &ldquo;Lead Qualification&rdquo; completed
                        successfully
                      </p>
                  ...
                  <div className='flex items-center gap-3'>
                    ...
                    <div className='flex-1'>
                      <p className='text-sm font-medium'>
                        New AI agent &ldquo;Customer Support Bot&rdquo; deployed
                      </p>
                  ...
                  <div className='flex items-center gap-3'>
                    ...
                    <div className='flex-1'>
                      <p className='text-sm font-medium'>
                        Workflow &ldquo;Email Automation&rdquo; triggered 15
                        times
                      </p>
                  ...
                  <div className='border-t pt-4'>
                    <div className='flex items-center justify-between text-sm'>
                      ...
                      <span className='font-medium'>
                        {tenant.billing.nextBilling.toLocaleDateString()}
                      </span>
                    </div>
              ...
              <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                <div className='text-center'>
                  <div className='mb-2 text-3xl font-bold text-blue-600'>
                    {(
                      ((usage?.executions || 0) / tenant.limits.executions) *
                      100
                    ).toFixed(1)}
                    %
                  </div>
                ...
                <div className='text-center'>
                  <div className='mb-2 text-3xl font-bold text-green-600'>
                    {(
                      ((usage?.apiCalls || 0) / tenant.limits.apiCalls) *
                      100
                    ).toFixed(1)}
                    %
                  </div>
                ...
                <div className='text-center'>
                  <div className='mb-2 text-3xl font-bold text-purple-600'>
                    {(
                      ((usage?.aiProcessing || 0) /
                        tenant.limits.aiProcessing) *
                      100
                    ).toFixed(1)}
                    %
                  </div>
