...
const phases = [
  ...
  },
  {
    ...
    description:
      "Build systems while enabling internal teams to confidently run them.",
    outputs: [
  ...
  },
  {
    ...
    description:
      "Hands-on enablement for teams building durable internal capability.",
    outputs: [
      "Use-case mapping",
      "Governance framework",
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
            Flexible ways to launch quickly, scale responsibly, and keep
            ownership aligned with your team.
          </p>
        </div>
